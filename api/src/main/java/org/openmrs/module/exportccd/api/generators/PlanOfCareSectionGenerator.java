...
public class PlanOfCareSectionGenerator {
	...
	public ContinuityOfCareDocument buildPlanOfCare(ContinuityOfCareDocument ccd, Patient patient) {
		...
		section.getTemplateIds().add(utils.buildTemplateID("2.16.840.1.113883.3.88.11.83.124", "", "HITSP/C83"));
		section.getTemplateIds().add(utils.buildTemplateID("1.3.6.1.4.1.19376.1.5.3.1.3.31", "", "IHE PCC"));
		section.getTemplateIds().add(utils.buildTemplateID("2.16.840.1.113883.10.20.2.7", "", "HL7 CCD"));
		section.getTemplateIds().add(utils.buildTemplateID("2.16.840.1.113883.10.20.1.10", "", "HL7 CCD"));
